...
int main(int argc, char *argv[])
{
   ...
   ofstream mesh_ofs("ted_beam_undisplaced.mesh");
   ...
   umf_solver.Mult(B, X);
#endif
   std::cout << "Solve time = " << float( clock () - begin_time ) /  CLOCKS_PER_SEC << std::endl;
   ...
   ParaViewDataCollection paraview_dc("PlateExample", mesh);
